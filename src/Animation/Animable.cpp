...
namespace PZ
{
	Animable::Animable() : animationManager(Application::GetSingleton().GetAnimationManager())
	{
	}
	Animable::~Animable()
	{
	...
	{
		return RunAnimationDirect(animationManager.CreateAnimation(animationType, properties));
	}
